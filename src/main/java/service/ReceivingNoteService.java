...
public class ReceivingNoteService {
    ...
    public List<ReceivingNote> getAllReceivingNotes(Integer page, Integer limit,
                                                    Long from, Long to){
    ...
    public List<ReceivingNoteDetail> getAllReceivingNoteDetails(Integer page, Integer limit){
